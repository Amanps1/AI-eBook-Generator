import { Twitter, BookOpen, Linkedin, Github } from "lucide-react";
import React from 'react'

const Footer = () => {
  return (
    <footer className="relative bg-gradient-to-br from-gray-950 to-violet-950 text-white overflow-hidden">
      {/* SubTittle BackGround Pattern */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-0 right-0 w-96 h-96 bg-violet-500 rounded-full blur-3xl"></div>
      </div>

      <div className="relative max-w-7xl max-auto px-6 lg:px-8">
          ...
          <div className="md:col-span-5 space-y-6">
            ...
            <div className="flex items-center space-x-3 pt-2">
              <a
                ...
                className="h-10 w-10 bg-white/5 hover:bg-violet-600 rounded-lg flex items-center justify-center transotion-all duration-200 hover:scale-105"
                arial-lable="Twitter"
              >
        ...
        <div className="border-t border-white/10 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            ...
            <p className="text-gray-500 text-sm">
              Made with
              <span className="text-violet-400"> Love</span> for Creators
            </p>
          </div>
        </div>
      </div>
