...
import HERO_IMAGE from "../../assets/large_Book-cover-ideas-5-ffcfaf.webp";
const Hero = () => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-xl space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <Link
                ...
                className="group inline-flex items-center space-x-2 bg-gradient-to-r from-violet-600 to-purple-600  text-white  px-8 py-4 rounded-xl font-semibold shadow-lg shadow-violet-500/30 hover:shadow-violet-500/50 hover:scale-105 transition-all dueation-200"
              >
                <span>Start Creating For Free</span>
                <ArrowRight className="w-5 h-5 group-hover:transition-x-1 transition-transform" />
              </Link>
            ...
            <div className="flex items-center gap-8 pt-4">
              ...
              <div className="w-px h-12 bd-gray-200"></div>
              <div>
          ...
          <div className="relative lg:pl-8 ">
            <div className="relative">
              ...
              <div className="relative bg-white rounded-xl shadow-xl overflow-hidden border border-gray-100">
                ...
                <div className="absolute top-6 right-6 bg-white rounded-2xl shadow-xl p-4 backdrop-blur-sm border border-gray-100 animate-in fade-in slide-in-from-right duration-700">
                  <div className="flex items-center space-x-3 ">
                    <div className="w-10 h-10 bg-gradient-to-br from-violet-500 to-purple-800 rounded-lg flex items-center justify-center">
              ...
              <div className="absolute bottom-6 left-6 bg-white rounded-2xl shadow-xl p-4 backdrop-blur-sm border-gray-100 animate-in  fade-in slide-in-from-left duration-700 delay-300">
                <div className="flex items-center space-x-3">
            ...
            <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-purple-400/20 rounded-full blur-3xl animate-pulse delay-700"></div>
          </div>
        </div>
      </div>
    </div>
